...
function printHelp() {
  ...
  echo
  echo "  byfn.sh generate -c $CHANNEL_NAME"
  echo "  byfn.sh up -c $CHANNEL_NAME -s couchdb"
  echo "        byfn.sh up -c $CHANNEL_NAME -s couchdb -i 1.4.0"
  echo "  byfn.sh up -l node"
  echo "  byfn.sh down -c $CHANNEL_NAME"
  echo "        byfn.sh upgrade -c $CHANNEL_NAME"
  echo
...
# channel name defaults to "myemr"
CHANNEL_NAME="myemr"
