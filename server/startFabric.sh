...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang"  ]; then
  ...
  CC_SRC_PATH=github.com/chaincode/emr/go
else
...
Next, use the ${CHAINCODE_NAME} applications to interact with the deployed ${CHAINCODE_NAME} contract.
The ${CHAINCODE_NAME} applications are available in multiple programming languages.
